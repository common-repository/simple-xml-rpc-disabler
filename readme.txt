...
This plugin **completely** disables the [XML-RPC API](http://xmlrpc.com/) which can be abused by hackers on a WordPress site, providing an easy and simple way to disable/enable the XML-RPC API.
